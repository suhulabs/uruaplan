...
<form method="post" enctype="multipart/form-data" id="formContenido">
  ...
  <div class="ficha-flyer">
    ...
    <section class="panel visible columna-foto">
      ...
      <?php if (!empty($flyer['logo_organizador'])): ?>
        <div style="margin-top:1rem;padding:0.75rem;background:rgba(255,255,255,0.04);border-radius:8px;border:1px solid rgba(255,255,255,0.08);text-align:center;">
          <small style="display:block;margin-bottom:0.4rem;color:#a3e635;font-weight:600;"><i class="fa-solid fa-copyright"></i> Logo del Organizador / Marca:</small>
          <img src="flyer-imagen.php?id=<?= (int) $flyer['id'] ?>&tipo=logo" alt="Logo Marca" style="max-height:45px;max-width:140px;object-fit:contain;">
        </div>
      <?php endif; ?>
    ...
    <section class="panel visible columna-datos">
      ...
      <div class="rejilla-campos">
        <div class="campo">
          ...
          <input type="text" id="evento" name="evento" class="input-texto" maxlength="80"
        ...
        <div class="campo">
          ...
          <input type="text" id="subtitulo" name="subtitulo" class="input-texto" maxlength="90"
        ...
        <div class="campo">
          ...
          <input type="text" id="ubicacion" name="ubicacion" class="input-texto" maxlength="120"
        ...
        <div class="campo">
          ...
          <input type="text" id="precio" name="precio" class="input-texto" maxlength="60"
                 value="<?= e($flyer['precio']) ?>">
        </div>

        <div class="campo">
          <label class="campo-label" for="contacto">Contacto</label>
          <input type="text" id="contacto" name="contacto" class="input-texto" maxlength="60"
      ...
      <div class="campo">
        ...
        <textarea id="descripcion" name="descripcion" rows="3" class="input-texto"
                  maxlength="250" data-contador="1"><?= e($flyer['descripcion']) ?></textarea>
        <small class="contador"></small>
        <p class="campo-ayuda">Es el texto que va dentro del flyer: se lee de un vistazo.</p>
      </div>
