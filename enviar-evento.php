...
$datos = array(
    'evento' => campo('evento', 45),
    'subtitulo' => campo('subtitulo', 60),
    'fecha' => campo('fecha', 10),
    'hora' => campo('hora', 5),
    'contacto' => campo('contacto', 30),
    'precio' => campo('precio', 30),
    'ubicacion' => campo('ubicacion', 70),
    'descripcion' => campo('descripcion', 160, true),
