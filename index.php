...
<body>
              ...
              <article class="evento-card<?= $pasado ? ' evento-pasado' : '' ?>">
                ...
                <div class="evento-cuerpo">
                  ...
                  <?php if ($ev['descripcion'] !== ''): ?>
                    <p class="evento-descripcion"><?= e($ev['descripcion']) ?></p>
                  <?php endif; ?>
                </div>
              </article>
            <?php endforeach; ?>
          ...
          <form id="contactForm" action="enviar-evento.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" id="formEventName" name="evento" class="form-control"
                  placeholder="Ej. Artes Visuales &amp; Literatura" maxlength="45" required>
              ...
              <div class="form-group">
                ...
                <input type="text" id="formSubtitle" name="subtitulo" class="form-control"
                  placeholder="Ej. Exposición Colectiva y Libro" maxlength="60" required>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" id="formContact" name="contacto" class="form-control"
                  placeholder="Ej. @cero_talleraleria / 452 123 4567" maxlength="30" required>
              ...
              <div class="form-group">
                ...
                <input type="text" id="formPrice" name="precio" class="form-control"
                  placeholder="Ej. Entrada libre / $150 MXN" maxlength="30" required>
            ...
            <div class="form-group">
              ...
              <input type="text" id="formLocation" name="ubicacion" class="form-control"
                placeholder="Ej. 2calle 1ra Privada de Juárez #31, Uruapan" maxlength="70" required>
            ...
            <div class="form-group">
              ...
              <textarea id="formDescription" name="descripcion" class="form-control" rows="4"
                placeholder="Detalles de la exposición, conversatorio o espectáculo..." maxlength="160"
                required></textarea>
        ...
        <div class="flyer-preview-wrapper">
          ...
          <div class="flyer-card" id="flyerCard">
            ...
            <div class="flyer-inner-content">
              ...
              <!-- Encabezado: Logo Uruaplan superior izquierdo -->
              ...
              <!-- Descripción con separador superior pegado -->
              <div class="flyer-desc-wrapper">
                <div class="flyer-divider"></div>
                <p id="flyerPreviewDesc">
                  <?= ce('contacto', 'flyer_descripcion') ?>
                </p>
              </div>
  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-grid">
        ...
        <nav class="footer-col" aria-label="Categorías de planes">
          <h4 class="footer-title"><?= ce('footer', 'cat_titulo') ?></h4>
          <ul class="footer-links">
            <?php for ($k = 1; $k <= 5; $k++): ?>
              <?php $cat = c('footer', 'cat_' . $k); ?>
              <?php if ($cat !== ''): ?>
                <li><a href="#galeria"><?= e($cat) ?></a></li>
              <?php endif; ?>
            <?php endfor; ?>
          </ul>
        </nav>
      ...
      <div class="footer-bottom">
        ...
        <?php endif; ?>
        <p class="footer-privacy" style="margin-top:0.4rem;">
          <a href="#modalPrivacidad" class="abrir-privacidad" style="opacity:0.8;font-size:0.85rem;text-decoration:underline;">
  ...
  <div class="lightbox" id="modalPrivacidad" role="dialog" aria-modal="true" aria-label="Aviso de Privacidad">
    <div class="lightbox-content" style="max-width:620px;background:var(--bg-card, #1e1e24);padding:2rem;border-radius:12px;color:var(--text-color, #fff);max-height:85vh;overflow-y:auto;position:relative;box-shadow:0 10px 30px rgba(0,0,0,0.5);">
      <button class="lightbox-close" id="cerrarModalPrivacidad" aria-label="Cerrar aviso de privacidad">&times;</button>
      <h3 style="margin-top:0;font-size:1.35rem;display:flex;align-items:center;gap:0.5rem;color:var(--color-primary, #ff3b5c);">
        <i class="fa-solid fa-shield-halved"></i> Aviso de Privacidad
      </h3>
      <p style="font-size:0.9rem;line-height:1.5;">
        Conforme a la <strong>Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP)</strong>, Uruaplan le informa sobre el tratamiento de la información recabada a través del formulario «Promociona tu Plan»:
      </p>
      <ul style="font-size:0.88rem;line-height:1.6;padding-left:1.2rem;margin-bottom:1rem;">
        <li><strong>Datos recabados:</strong> Información de la obra o evento, datos de contacto de quien publica, foto representativa, dirección IP y agente de usuario. Opcionalmente, coordenadas GPS si decide compartirlas.</li>
        <li><strong>Finalidad del tratamiento:</strong> Moderación de contenido, verificación antispam para evitar abusos, publicación en cartelera y redes sociales autorizadas, y contacto en caso de aclaración.</li>
        <li><strong>Tiempo de retención:</strong> Los registros de diagnóstico técnico (IP y User-Agent) se eliminan automáticamente tras <strong>6 meses</strong> mediante purga programada.</li>
        <li><strong>Transferencia de datos:</strong> Sus datos no son vendidos, arrendados ni compartidos con terceros ajenos a la plataforma.</li>
        <li><strong>Derechos ARCO:</strong> Puede solicitar el acceso, rectificación, cancelación u oposición al tratamiento de sus datos escribiendo a <code><?= e($correoForm) ?></code>.</li>
      </ul>
    </div>
  </div>
